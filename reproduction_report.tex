...
\rowcolor{green!8}
ST-LLM w/ Ours (\repro, self-port) & 15.1\% & 0.26$\times$ & 54.80 & 42.59 & 59.80 / \na & \na & \na & \na & \na & \na & \na \\
\midrule
...
\rowcolor{green!8}
AOT (\repro) & 8.7 & 21.3\% & 25\% & 57.75 & 61.18$^\dagger$ & 52.80 & 54.59 & 56.58 & 96.8 \\
...
\rowcolor{green!8}
AOT (\repro) & 7.0 & 17.2\% & 20\% & 57.73 & 61.22$^\dagger$ & 53.18 & 58.59 & 57.68 & 98.7 \\
...
\rowcolor{green!8}
AOT (\repro) & 3.4 & 8.3\% & 15\% & 57.33 & 60.98$^\dagger$ & 52.73 & 53.70 & 56.19 & 96.2 \\
...
\rowcolor{green!8}
AOT (\repro) & 5.2 & 12.7\% & 10\% & 56.70 & 60.45$^\dagger$ & 52.06 & 53.30 & 55.63 & 95.2 \\
\bottomrule
\end{tabular}}
\caption{AOT main experiment table on LLaVA-OneVision with local reproduction rows inserted below the corresponding paper AOT rows. $^\dagger$EgoSchema full-test labels are not public; accuracy is obtained by submitting the local predictions to the official validation server (the same predictions also agree with the authors' committed submissions on 94--99\% of items). Averages are computed over the four benchmarks, with Avg.\ \% relative to the full-model baseline.}
