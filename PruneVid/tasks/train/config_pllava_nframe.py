...
model = dict(
    ...
    repo_id="MODELS/llava-1.6",
    # repo_id="MODELS/llava-1.6-7b-next-video-dpo",
    # repo_id="MODELS/tarsier",
    ...
    # lm_unfreeze_modules=['layernorm', 'embed_tokens', 'norm', 'lm_head'],
...
wandb = dict(
    ...
    project="DE_LLAVA",  # setup in your command line
)
dist_url = "env://"
device = "cuda"
mode = "it"
