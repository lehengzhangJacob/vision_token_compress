...
class VideoQABenchDataset(EvalDataset):
    ...
    data_list_info = OrderedDict({
        "MSVD_QA": OrderedDict(
            q_json_relpath="MSVD_Zero_Shot_QA/val_q.json", 
            a_json_relpath="MSVD_Zero_Shot_QA/val_a.json", 
        ...
        "MSRVTT_QA": OrderedDict(
            q_json_relpath="MSRVTT_Zero_Shot_QA/val_q.json", 
            a_json_relpath="MSRVTT_Zero_Shot_QA/val_a.json", 
        ...
        "ActivityNet": OrderedDict(
            q_json_relpath="ActivityNet/val_q.json", 
            a_json_relpath="ActivityNet/val_a.json", 
        ...
        "TGIF_QA": OrderedDict(
            q_json_relpath="TGIF_QA/val_q.json", 
            a_json_relpath="TGIF_QA/val_a.json", 
