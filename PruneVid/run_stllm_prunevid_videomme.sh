...
OUT_DIR="${OUT_DIR:-/home/msj_team/Jacob/nk/PruneVid/test_results/stllm-prunevid-videomme}"
...
"${PYTHON_BIN}" stllm/test/prunevid_ext/video_mcq_infer.py \
    ...
    --ckpt-path "${CKPT_PATH}" \
    --anno-path \
        /home/msj_team/Jacob/nk/PruneVid/DATAS/Video-MME/json/short.json \
        /home/msj_team/Jacob/nk/PruneVid/DATAS/Video-MME/json/medium.json \
        /home/msj_team/Jacob/nk/PruneVid/DATAS/Video-MME/json/long.json \
    --video-root /home/msj_team/Jacob/nk/PruneVid/DATAS/Video-MME/data \
    --output-dir "${OUT_DIR}" \
    --output-name stllm_prunevid_videomme \
